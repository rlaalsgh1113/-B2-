# -B2-
# [폰시세] 휴대폰 대리점 가격 비교 서비스 (데모 버전)
## 📱폰시세 - 내 주변 가장 저렴한 대리점 찾기
&nbsp;'폰시세'는 내 주변 휴대폰 대리점(성지)의 실시간 시세를 비교하고, 지도에서 위치·경로를 확인하며, 사용자 후기를 공유할 수 있는 서비스입니다.


**기능 시연 화면**

- 데모 버전으로 별도 홍보 영상은 제공하지 않으며, 아래 [메인 제공 기능](#메인-제공-기능)에서 화면별 기능을 확인할 수 있습니다.
...
## 💻프로젝트 소개
프로젝트 이름: 폰시세 ( 휴대폰 대리점 가격 비교 서비스 )

프로젝트 주제: 위치 기반 휴대폰 대리점 실시간 시세 비교 및 커뮤니티 앱 (데모)
...
**[API 설명]** - 데모 버전으로 별도의 백엔드 API가 없으며, 모든 데이터는 클라이언트에서 생성되는 목업 데이터입니다.
